...
import com.sshakusora.riautomobility.interaction.client.VehicleInteractionDebugRenderer;
...
import com.sshakusora.riautomobility.recipe.RIAutomobilityRecipes;
...
public class RIAutomobility
{
    ...
    private void registerAll(IEventBus bus){
        ...
        RIAutomobilityRecipes.SERIALIZERS.register(bus);
    ...
    public static class RIAutomobilityClient{
        ...
        public static void onClientSetup(final FMLClientSetupEvent event){
            ...
            MinecraftForge.EVENT_BUS.addListener(VehicleInteractionDebugRenderer::onRenderLevelStage);
